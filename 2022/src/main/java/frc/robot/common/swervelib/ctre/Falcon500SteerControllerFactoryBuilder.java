package frc.robot.common.swervelib.ctre;

import com.ctre.phoenix.motorcontrol.*;
import com.ctre.phoenix.motorcontrol.can.TalonFX;
import com.ctre.phoenix.motorcontrol.can.TalonFXConfiguration;
import frc.robot.common.swervelib.*;
import edu.wpi.first.wpilibj.shuffleboard.ShuffleboardContainer;

import static frc.robot.common.swervelib.ctre.CtreUtils.checkCtreError;
    ...
    private class FactoryImplementation<T> implements SteerControllerFactory<ControllerImplementation, Falcon500SteerConfiguration<T>> {
        ...
        public ControllerImplementation create(Falcon500SteerConfiguration<T> steerConfiguration, ModuleConfiguration moduleConfiguration) {
            ...
            if (hasMotionMagic()) {
                ...
                // 2910TODO: What should be done if no nominal voltage is configured? Use a default voltage?

                // 2910TODO: Make motion magic max voltages configurable or dynamically determine optimal values
