...
public class AutonomousChooser {
    ...
    public AutonomousChooser(AutonomousTrajectories trajectories) {
        ...
        autonomousModeChooser.setDefaultOption("DEMO MODE", AutonomousMode.NONE);
        ...
        // autonomousModeChooser.addOption("(RIGHT/HP) 5 Ball",
        // AutonomousMode.FIVE_RIGHT);
        // autonomousModeChooser.addOption("(LEFT/HP) 4 Ball",
        // AutonomousMode.FOUR_LEFT);
        // autonomousModeChooser.addOption("(RIGHT) 3 Ball",
        // AutonomousMode.THREE_RIGHT);
        // //autonomousModeChooser.addOption("(RIGHT) 3 Ball Slow",
        // AutonomousMode.THREE_RIGHT_SLOW);
        // autonomousModeChooser.addOption("(LEFT) 2+2 Ball (HANGAR)",
        // AutonomousMode.TWO_AND_TWO_LEFT_HANGAR);
        // autonomousModeChooser.addOption("(LEFT) 2+2 Ball (HUB)",
        // AutonomousMode.TWO_AND_TWO_LEFT_HUB);
        // autonomousModeChooser.addOption("(LEFT) TAXI+1 Ball",
        // AutonomousMode.ONE_LEFT);
        // autonomousModeChooser.addOption("(LEFT/FRONT) TAXI+1 Ball",
        // AutonomousMode.ONE_LEFT_FRONT);
        // autonomousModeChooser.addOption("(RIGHT/FRONT) TAXI+1 Ball",
        // AutonomousMode.ONE_RIGHT_FRONT);
        // autonomousModeChooser.addOption("(RIGHT) TAXI+1 Ball",
        // AutonomousMode.ONE_RIGHT);
        // autonomousModeChooser.addOption("(LEFT) ASSIST 3 BALL (HANGAR)",
        // AutonomousMode.ASSIST_HANGAR);
        // autonomousModeChooser.addOption("(LEFT) ASSIST 3 BALL (HUB)",
        // AutonomousMode.ASSIST_HUB);
    }
    ...
    /*
     * private SequentialCommandGroup getTwoRightAutoCommand(RobotContainer
     * container) {
     * SequentialCommandGroup command = new SequentialCommandGroup();
     * 
     ...
     * }
     * 
     * private SequentialCommandGroup getTwoLeftAutoCommand(RobotContainer
     * container) {
     * SequentialCommandGroup command = new SequentialCommandGroup();
     * 
     ...
     * }
     * 
     * private SequentialCommandGroup getFiveRightAutoCommand(RobotContainer
     * container) {
     * SequentialCommandGroup command = new SequentialCommandGroup();
     * 
     ...
     * followIntakeAndPreShoot(command, container,
     * trajectories.getFiveRightAuto2());
     * //followIntakeAndShoot(command, container, trajectories.getFiveRightAuto3(),
     * -400);
     * //aimAndShoot(command,container, 1.75);
     * followIntakeAndPreShoot(command, container,
     * trajectories.getFiveRightAuto3());
     ...
     * followIntakeAndPreShoot(command, container,
     * trajectories.getFiveRightAuto5());
     * aimAndShoot(command, container, 2.0);
     * 
     * return command;
     * }
     * 
     * private SequentialCommandGroup getFourLeftAutoCommand(RobotContainer
     * container) {
     * SequentialCommandGroup command = new SequentialCommandGroup();
     * 
     ...
     * }
     * 
     * private SequentialCommandGroup getThreeRightAutoCommand(RobotContainer
     * container) {
     * SequentialCommandGroup command = new SequentialCommandGroup();
     * 
     ...
     * followIntakeAndPreShoot(command, container,
     * trajectories.getThreeRightAuto3());
     ...
     * }
     * 
     * private SequentialCommandGroup getThreeRightSlowAutoCommand(RobotContainer
     * container) {
     * SequentialCommandGroup command = new SequentialCommandGroup();
     * 
     * resetRobotPose(command, container, trajectories.getFiveRightAuto1());
     ...
     * getTwoAndTwoLeftAutoHangarCommand(RobotContainer container) {
     * SequentialCommandGroup command = new SequentialCommandGroup();
     * 
     ...
     * setShotTypeHangar(command, container);
     * followAndPreShoot(command, container,
     * trajectories.getTwoAndTwoLeftAuto5Hangar());
     * shoot(command, container, 1.5);
     * //followAndIntake(command, container,
     * trajectories.getTwoAndTwoLeftAuto6Hangar());
     * setShotTypeLimelight(command, container);
     * 
     * return command;
     * }
     * 
     * private SequentialCommandGroup getTwoAndTwoLeftAutoHubCommand(RobotContainer
     * container) {
     * SequentialCommandGroup command = new SequentialCommandGroup();
     * 
     * resetRobotPose(command, container, trajectories.getTwoAndTwoLeftAuto1());
     ...
     * followAndPreShoot(command, container,
     * trajectories.getTwoAndTwoLeftAuto5Hub());
     * shoot(command, container, 1.5);
     * //followAndIntake(command, container,
     * trajectories.getTwoAndTwoLeftAuto6Hub());
     * setShotTypeLimelight(command, container);
     * 
     * return command;
     * }
     * 
     * private SequentialCommandGroup getTaxiAutoLeftCommand(RobotContainer
     * container) {
     * SequentialCommandGroup command = new SequentialCommandGroup();
     * 
     ...
     * }
     * 
     * private SequentialCommandGroup getTaxiAutoLeftFrontCommand(RobotContainer
     * container) {
     * SequentialCommandGroup command = new SequentialCommandGroup();
     * 
     ...
     * }
     * 
     * private SequentialCommandGroup getTaxiAutoRightFrontCommand(RobotContainer
     * container) {
     * SequentialCommandGroup command = new SequentialCommandGroup();
     * 
     ...
     * }
     * 
     * private SequentialCommandGroup getTaxiAutoRightCommand(RobotContainer
     * container) {
     * SequentialCommandGroup command = new SequentialCommandGroup();
     * 
     ...
     * }
     * 
     * private SequentialCommandGroup getAssistHangarAutoCommand(RobotContainer
     * container) {
     * SequentialCommandGroup command = new SequentialCommandGroup();
     * 
     ...
     * setShotTypeHangar(command, container);
     * followAndPreShoot(command, container, trajectories.getAssistAuto4Hangar());
     * shoot(command, container, 1.5);
     * setShotTypeLimelight(command, container);
     * 
     * return command;
     * }
     * 
     * private SequentialCommandGroup getAssistHubAutoCommand(RobotContainer
     * container) {
     * SequentialCommandGroup command = new SequentialCommandGroup();
     * 
     * resetRobotPose(command, container, trajectories.getAssistAuto1());
     ...
     * followAndIntake(command, container, trajectories.getAssistAuto3());
     * setShotTypeLow(command, container);
     * followAndPreShoot(command, container, trajectories.getAssistAuto4Hub());
     * shoot(command, container, 1.5);
     * setShotTypeLimelight(command, container);
     * 
     * return command;
        ...
        command.addCommands(new FollowTrajectoryCommand(container.getDrivetrainSubsystem(), trajectory)
                .deadlineWith(
                        new ParallelCommandGroup(
                                new PreShootCommand(container.getPreShooterSubsystem(), container.getShooterSubsystem(),
    ...
    private void setShotTypeHangar(SequentialCommandGroup command, RobotContainer container) {
        command.addCommands(
                new ShooterHoodRetractCommand(container.getShooterSubsystem()),
                new ChangeShotTypeCommand(container.getShooterSubsystem(), container.getPreShooterSubsystem(),
                        "hangar"));
    }
    ...
    private void aimAndShoot(SequentialCommandGroup command, RobotContainer container, double timeout) {
        command.addCommands(new ParallelRaceGroup(
                new RotateToLimelightCommand(container.getDrivetrainSubsystem(), container.getDriveForwardAxis(),
                        container.getDriveStrafeAxis(), container.getLimelightSubsystem(), false),
    ...
    private void aim(SequentialCommandGroup command, RobotContainer container, double timeout) {
        command.addCommands(
                new RotateToLimelightCommand(container.getDrivetrainSubsystem(), container.getDriveForwardAxis(),
                        container.getDriveStrafeAxis(), container.getLimelightSubsystem(), false).withTimeout(timeout));
    }
    ...
    private void followIntakeAndShoot(SequentialCommandGroup command, RobotContainer container, Trajectory trajectory,
            double RPMChange) {
        command.addCommands(new FollowTrajectoryCommand(container.getDrivetrainSubsystem(), trajectory)
                .deadlineWith(new ParallelCommandGroup(
                        ...
                        new MovingShootCommand(container.getShooterSubsystem(), container.getPreShooterSubsystem(),
                                container.getFeederSubsystem(), container.getLimelightSubsystem(),
                                container.getDrivetrainSubsystem(), RPMChange))));
    }
    */

    private void resetRobotPose(SequentialCommandGroup command, RobotContainer container, Trajectory trajectory) {
        command.addCommands(new InstantCommand(() -> container.getDrivetrainSubsystem()
                .resetGyroAngle(trajectory.calculate(0.0).getPathState().getRotation().inverse())));
    ...
    private enum AutonomousMode {
        ...
        THREE_RIGHT,
        THREE_RIGHT_SLOW,
        TWO_AND_TWO_LEFT_HANGAR,
        TWO_AND_TWO_LEFT_HUB,
        ONE_LEFT,
        ONE_LEFT_FRONT,
        ONE_RIGHT_FRONT,
        ONE_RIGHT,
